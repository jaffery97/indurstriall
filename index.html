...
<body>
	...
	<div id="slider">
		<ul>
			<li style="background-image: url(images/dump-truck-3080177_1920.jpg)">
				<h3>Material Handing</h3>
				<h2>Platform Trucks</h2>
				<a href="#" class="btn-more">Read more</a>
			</li>
			<li class="purple" style="background-image: url(images/me1.jpg)">
				<h3>Furniture & Office supplies</h3>
				<h2>School Supplies</h2>
				<a href="#" class="btn-more">Read more</a>
			</li>
			<li class="yellow" style="background-image: url(images/machine-3023876_1920.jpg)">
				<h3>Packaging & supplies</h3>
				<h2>Labels & Dispensers</h2>
				<a href="#" class="btn-more">Read more</a>
			</li>
		</ul>
	</div>
		...
		<div class="container">
			<div class="last-products">
				...
				<section class="products">
					<article>
						<img src="images/dump-truck-3080177_1920.jpg" alt="">
						<h3>Excepteur sint occaecat</h3>
						<h4>$1 850.00</h4>
						<a href="cart.html" class="btn-add">Add to cart</a>
					</article>
					<article>
						<img src="images/machine-3023876_1920.jpg" alt="">
                    ...
                    <article>
						<img src="images/industrial-1636403_1920.jpg" alt="">
						<h3>magna aliqua</h3>
						<h4>$3 500.00</h4>
						<a href="cart.html" class="btn-add">Add to cart</a>
					</article>
                    ...
                    <article>
						<img src="images/industry-94448_1920.jpg" alt="">
						<h3>magna aliqua</h3>
						<h4>$3 500.00</h4>
						<a href="cart.html" class="btn-add">Add to cart</a>
					</article>
